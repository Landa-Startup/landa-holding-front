...
export default async function ContactUsPage({
  ...
  return (
    <div>
      ...
      <div className='container mx-auto grid grid-cols-1 gap-12 bg-[#FAFAFA] px-5 py-8 font-barlow text-black md:py-28 md:flex md:flex-row md:justify-between lg:px-28'>
