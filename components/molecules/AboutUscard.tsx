    ...
    <>
      {reverse && (
        <div className='flex flex-col-reverse py-12 leading-6 justify-items-center md:grid md:grid-cols-2  '>
          <div className='px-[30px] md:px-0 leading-6 text-black md:ml-8 '>
            ...
            <button className=' justify-items-center mx-auto bg-[#AA8453] text-white md:mt-20 mt-8  flex px-10 py-2 font-barlow'>Visit Now</button>
          </div>
          <div className='col-span-1 md:pl-16'>
            <img className="mb-2 md:w-[650px] md:h-[300px] w-[430px] h-[110px] md:mt-2 " style={{
      ...
      {!reverse && (
        <div className='flex md:py-12 flex-col md:grid md:grid-cols-2'>
          ...
          <img className="mb-2 md:w-[650px] md:h-[300px] w-[430px] h-[150px] md:mt-2 " style={{
              backgroundImage: `url(${image})`,
              backgroundSize: 'cover',
              backgroundPosition: 'center'
            }} />
