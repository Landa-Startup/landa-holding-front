    ...
    <div>
      ...
      <div className="flex my-3">
        ...
        <ul className="mx-4">
          ...
          <li>
            <a className="text-[#AA8453]" href="tel:+14165577622">
              Canada: +1 (416) 557-7622
            </a>
          </li>
          <li>
            <a className="text-[#AA8453]" href="tel:02188030167">
              Tehran: 02188030167
            </a>
          </li>
          <li>
            <a className="text-[#AA8453]" href="tel:03131311914">
              Isfahan: 03131311914
            </a>
          </li>
        </ul>
