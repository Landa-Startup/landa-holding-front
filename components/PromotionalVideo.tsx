  ...
  return (
    ...
    >
      <div className="absolute flex flex-col items-center top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        ...
        <div className="w-373 h-12 text-white text-4xl font-normal tracking-wider font-gilda">
          Promotional Video
        </div>
        <button className="relative w-14 h-14 bg-zinc-300 rounded-full border border-primary border-spacing-2">
