  ...
  return (
    <>
      <div className='text-center'>
        <p className='mb-20 pt-8 font-serif text-2xl tracking-wide md:pt-8 md:text-5xl lg:text-6xl xl:text-7xl'>{lang === "en" ? "Investor Registration Form" : "فرم مرکز سرمایه گذار"}</p>
      </div>
      <div>
