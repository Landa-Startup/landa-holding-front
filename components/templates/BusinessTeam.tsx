...
export default function AerialViewBusinessTeam() {
  return (
    ...
    >
      ...
      <div className="md:w-9/12 mx-auto p-5 flex flex-col items-center bg-neutral-500 bg-opacity-60 w-96">
        <div className="flex md:flex-col md:items-center w-96 md:w-full">
          ...
          <div className="p-2.5 justify-center items-center gap-2.5 inline-flex w-2/3">
            <div className="text-stone-100 text-xs md:text-xl font-medium leading-[20px] md:leading-7 font-barlow">
