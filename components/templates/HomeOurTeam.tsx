...
export default function HomeOurTeam() {
  ...
  return (
    <div className="w-full bg-white flex-col justify-start items-center relative gap-9 inline-flex ">
      ...
      <Link href={'/our-team'}>
        <button className=" justify-items-center mx-auto bg-[#AA8453] text-white md:mt-8 flex px-10 py-2 mb-8 font-barlow">
          View More
        </button>
      </Link>{' '}
    </div>
