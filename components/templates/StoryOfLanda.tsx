    ...
    <div className="flex flex-col px-32 py-14 gap-12 bg-[#F7F3EE]">
      <div className="flex gap-12 text-[#000]">
        <div className="flex flex-col w-1/2 text-justify">
          ...
          <span className="font-gilda text-3xl text-primary mt-9">
            The story of Landa
          </span>
      ...
      <div className="flex gap-12 text-[#000]">
        ...
        <div className="w-1/2 text-justify">
          ...
          <span className="text-primary font-bold">What sets us apart: 1.</span>
          <p>
            Specialized Screening and Analysis of Startups: We specialize in
            screening and analyzing startups, creating opportunities for members
            to learn from each other. 2. Members Invest Directly: Members invest
            directly in startups of their choice, creating an environment where
            no member feels pressured to invest, and no member misses out on
            potential investment opportunities. 3. Focus on Building Investor
            Connections: Our primary approach is to foster connections among
            members, involving not only charitable activities but also numerous
            entertaining activities and social events. 4. Value Supporters&apos;
            Financial Contributions: We highly value the financial contributions
            of our supporters. Their opinions and guidance contribute to all
            aspects of the holding&apos;s operations. 5. Inclusive Structure:
            Our structure provides an opportunity for entrepreneurs to engage
            with reputable investors who have the capacity to invest at the
            startup level. 6. Collaboration with Other Investment Centers: We
            welcome collaboration with other investment centers and investment
