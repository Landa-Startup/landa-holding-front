...
export default function TeamPersons() {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 justify-items-center gap-4 py-5 md:container md:px-12 lg:px-10 xl:px-28 md:mx-auto md:grid-cols-2 lg:grid-cols-3  xl:grid-cols-4">
        {filteredPersons.map(
          (
            {
              image,
