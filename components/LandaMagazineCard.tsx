  ...
  return (
    <div className="w-[391px] h-[476px]">
      ...
      <div className="w-[46px] h-[84px] px-1 py-2.5 border border-white flex-col justify-start items-center gap-[15px] inline-flex absolute top-6">
        <div className="w-[31px] h-[17px] text-white text-[15px] font-normal">
          apr
        </div>
        <div className="w-[38px] h-8 text-white text-[32px] font-normal">
          27
        </div>
      </div>
      <div className="w-[306px] h-36 px-11 py-[13px] bg-stone-100 flex-col justify-start items-start gap-[7px] inline-flex top-[397px] left-[105px] absolute">
        <div className="text-stone-500 text-base font-normal tracking-[5.60px]">
          {type}
        </div>
        <div className="w-[218px] text-black text-[32px] font-normal">
          {title}
        </div>
      </div>
    </div>
