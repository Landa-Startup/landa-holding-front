...
const StartUpTrialRefactore = (props: Props) => {
  ...
  return (
    <div className="w-full h-auto px-4 my-4">
      <div className="w-full h-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-20">
        <div className="col-span-1 h-auto flex flex-col gap-2 items-center">
          <div className="w-full h-auto flex flex-row justify-start items-center mt-2 mb-1">
            <p className="text-black font-medium font-barlow text-[16px] leading-[19px]">
              {t('startUp',{ returnObjects: true }).trial.pitchDeck}
            </p>
          </div>
          <div className="w-full h-auto bg-whiteGold drop-shadow-md px-2 py-4">
            <div className="w-full h-auto flex flex-row items-center justify-around cursor-pointer">
              ...
              >
                ...
                <p
                  id={''}
                  className="text-grayCheckBox font-barlow font-medium text-[15px] leading-[18px]"
                >
                  {t('yes')}
                </p>
              </div>
            ...
            <div className="w-full h-auto">
              <div className="w-full grid grid-cols-1 gap-x-6 gap-y-4 my-2">
                <Input
                  ...
                  type={'text'}
                  required={
                    t('startUp', { returnObjects: true }).productNameRequired
                  }
                  patternValue={''}
                  patternMessage={''}
                  placeholder={
                    t('startUp', { returnObjects: true }).productNamePlaceholder
                  }
                  className={
                    'border-[1px] col-span-1 rounded-lg border-primary bg-whiteGold p-2'
                  }
                />
                <Input
                  register={register}
                  ...
                  type={'text'}
                  required={
                    t('startUp', { returnObjects: true }).siteAddressRequired
                  }
                  patternValue={''}
                  patternMessage={''}
                  placeholder={
                    t('startUp', { returnObjects: true }).siteAddressPlaceholder
                  }
                  className={
                    'border-[1px] col-span-1 rounded-lg border-primary bg-whiteGold p-2'
                  }
        ...
        <div className="col-span-1 h-auto flex flex-col gap-2 items-center">
          <div className="w-full h-auto flex flex-row justify-start items-center mt-2 mb-1">
            <p className="text-black font-medium font-barlow text-[16px] leading-[19px]">
              {t('startUp',{ returnObjects: true }).trial.businessPlan}
            </p>
          </div>
          <div className="w-full h-auto bg-whiteGold drop-shadow-md px-2 py-4">
            <div className="w-full h-auto flex flex-row items-center justify-around cursor-pointer">
        ...
        <div className="col-span-1 h-auto flex flex-col gap-2 items-center">
          <div className="w-full h-auto flex flex-row justify-start items-center mt-2 mb-1">
            <p className="text-black font-medium font-barlow text-[16px] leading-[19px]">
            {t('startUp',{ returnObjects: true }).trial.financial}
            </p>
          </div>
          <div className="w-full h-auto bg-whiteGold drop-shadow-md px-2 py-4">
            <div className="w-full h-auto flex flex-row items-center justify-around cursor-pointer">
      ...
      <div
        className={`w-full h-auto cursor-pointer py-6 my-4 ${problemsOpen ? 'bg-grayCheckBox' : 'bg-grayDark'}`}
        onClick={() => {
          setProblemsOpen(!problemsOpen);
        }}
      >
        <div className="w-full h-auto flex justify-center items-center gap-2">
          <p className="font-barlow text-white font-semibold text-[24px] leading-[20px]">
          {t('startUp',{ returnObjects: true }).trial.problems}
          </p>
          <div
            className={`${problemsOpen ? 'rotate-180' : 'rotate-0'} transition-all duration-300 ease-out mt-2`}
          >
            <ChevDown />
          </div>
        </div>
      ...
      />
      <TargetMarketDropDown register={register} errors={errors} />
      <PropertyDropDown register={register} errors={errors} />
    </div>
  );
};
