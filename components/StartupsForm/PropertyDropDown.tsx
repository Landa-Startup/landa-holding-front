          ...
          <>
            <div className='w-full md:w-2/3 mb-8 h-auto md:px-1'>
              <TextArea
                  ...
                  register={register}
                  errors={errors} 
                  required={t('startUp',{ returnObjects: true }).trial.propertyRevenueRequired}
            ...
            <div className='w-full md:w-2/3 mb-8 h-auto md:px-1'>
              <TextArea 
                  ...
                  register={register}
                  errors={errors} 
                  required={t('startUp',{ returnObjects: true }).trial.propertyMonthlyRequired}
                  nameTextArea={"businessModel"} 
                  patternValue={''} 
                  patternMessage={''} 
            ...
            <div className='w-full md:w-2/3 mb-8 h-auto md:px-1'>
              <TextArea 
                  ...
                  register={register}
                  errors={errors} 
                  required={t('startUp',{ returnObjects: true }).trial.propertyRateRequired}
                  nameTextArea={"businessModel"} 
                  patternValue={''} 
                  patternMessage={''} 
            ...
            <div className='w-full md:w-2/3 mb-8 h-auto md:px-1'>
              <TextArea 
                  ...
                  register={register}
                  errors={errors} 
                  required={t('startUp',{ returnObjects: true }).trial.propertyBusinessRequired}
                  nameTextArea={"businessModel"} 
                  patternValue={''} 
                  patternMessage={''} 
            ...
            <div className='w-full md:w-2/3 mb-8 h-auto md:px-1'>
              <TextArea 
                  ...
                  register={register}
                  errors={errors} 
                  required={t('startUp',{ returnObjects: true }).trial.propertyCapitalRequired}
                  nameTextArea={"businessModel"} 
                  patternValue={''} 
                  patternMessage={''} 
