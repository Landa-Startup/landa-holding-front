...
export default async function LandaHoldingBlack() {
  ...
  return (
    <div
      className="md:pr-40' relative flex flex-col items-center  justify-evenly space-y-5 bg-[#ffffff] py-5 md:h-[590px] md:flex-row md:justify-between md:py-10 md:pr-20 ltr:md:pl-36 rtl:md:pl-20">
      <Lines />
      <div className="z-10 flex h-[28rem] flex-col justify-between rtl:mr-1">
        <div className="flex flex-col items-center self-start md:items-start">
          <div className="flex flex-col">
            <span
              className="rtl:tracking-0 font-condensed text-xl font-normal text-black ltr:tracking-[5.60px]"
            >
              {t('LandaHolding')}
            </span>
