  ...
  return (
    <div className='min-h-[400px] bg-[#F8F5F0]'>
        <div className='relative'>
            <div className='absolute left-20 p-2 rtl:right-28 md:left-[185px] md:top-[29px] md:text-4xl md:rtl:right-48 rtl:md:top-[24px]'>
        ...
        <div className='relative'>
            <div className="absolute top-[52px] hidden h-[313.88px] w-16 ltr:left-10 rtl:right-10 md:block ltr:md:left-[121px] rtl:md:right-[121px]">
