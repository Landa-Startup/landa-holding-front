...
export default function HomeCardsSection({
  ...
  return (
    <div className={`flex flex-col-reverse ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'} gap-x-10 items-center justify-between last:border-none`}>
      <div className="flex flex-col h-full items-start justify-between gap-12 rtl:gap-16 md:w-1/2">
        <div className='flex flex-col items-start gap-4'>
            <span className='font-gilda text-1xl md:text-1xl'>
              {smallTitle}
            </span>
      ...
      <div className={`${reverse ? "md:justify-start" : "md:justify-end"} space-x-4 rtl:space-x-reverse flex w-full h-full md:w-1/2 md:pb-0`}>
