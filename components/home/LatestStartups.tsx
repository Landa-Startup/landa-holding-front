      ...
      <div className="bg-whiteGold flex flex-col items-center p-5 text-center">
        <div className="flex-col items-start justify-start md:ml-44 md:self-start rtl:md:ml-40">
          <div className="flex flex-col items-center md:items-start">
            <div className={`ltr:tracking-0 md:tracking-0 font-condensed ps-1 text-sm text-xl font-normal text-neutral-800 rtl:tracking-[3.5px] md:text-base md:tracking-[5.60px]`}>
              {t('LandaHolding')}
            </div>
