...
export default async function HomeCards({
  ...
  return (
    <div
      className={`${flexDirectionClass} relative flex items-center justify-between border-b-2 border-primary px-9 py-5 last:border-none md:border-none md:px-32 md:pt-80`}
    >
