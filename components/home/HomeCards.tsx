...
export default async function HomeCards({
  ...
  return (
    <div className='relative flex flex-col items-center justify-between border-b-2 border-primary px-9 py-5 last:border-none md:border-none md:p-28 ltr:md:flex-row rtl:md:flex-row-reverse'>
