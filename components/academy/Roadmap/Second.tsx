...
export default function Third() {
  return (
    <div
      ...
      id="Roadmap-3"
    >
      <div className="flex flex-col md:flex-row-reverse justify-evenly pt-2 pb-8 z-10 px-10 space-y-4">
        <Image
          alt="Landa academy"
        ...
        <div className="flex flex-col justify-evenly">
          ...
          <div className="justify-start items-start gap-2 inline-flex">
            ...
            <div className="w-[454px] text-xl font-normal font-barlow leading-10 text-justify">
              <ul className="text-white font-barlow text-xl font-medium leading-[25px] md:leading-[50px] tracking-[1px]">
