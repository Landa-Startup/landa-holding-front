...
export default function ContactUs() {
  return (
    <div className="relative md:w-[1440px] md:h-[694px] md:pl-[200px] md:pr-[120px] md:pt-[38px] md:pb-[104px] pt-5 bg-[#F1F8EC] flex flex-col justify-center items-center gap-[37px]">
