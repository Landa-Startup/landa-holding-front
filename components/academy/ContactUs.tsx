...
export default function ContactUs() {
  return (
    <div className="md:w-[1440px] md:h-[694px] md:pl-[121px] md:pr-[120px] md:pt-[38px] md:pb-[104px] pt-5 bg-[#F1F8EC] flex-col justify-start items-center gap-[37px] flex">
      ...
      <div className="md:w-[1199px] md:h-[304px] relative flex-col justify-start items-center flex space-y-4">
        <div className="flex flex-col space-y-4 md:flex-row justify-between md:w-[794px]">
          <input
