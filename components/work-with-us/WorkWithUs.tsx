      ...
      <div className="container m-[-1rem] mx-auto my-20 gap-y-0 px-5 font-barlow lg:p-20 flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col w-full">
          <div className="grid grid-cols-1 gap-x-6 bg-[#F8F5F0] p-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Select register={register} errors={errors} nameInput="uni" label={unis.placeholder} required="" className="select select-bordered mt-4 w-full max-w-xs px-8"  dark:text-current" placeholder={unis.placeholder} options={TypeOfUnis} handleChange={handleUniChange} selected={selectUni}
            />
          </div>
          {/* next line */}
          ...
          <div className="grid grid-cols-1 gap-x-6 bg-[#F8F5F0] p-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className='col-span-1'>
              <Select register={register} errors={errors} nameInput="langLevel" label={langLevel.placeholder} required="" className="select select-bordered mt-4 w-full px-8 shadow-sm"  dark:text-current" placeholder={langLevel.placeholder} options={TypeOfSkillLevels} handleChange={handleUniChange} selected={langLevel.placeholder}
              />
            </div>
          </div>
