<<<<<<< HEAD:components/molecules/AboutUsLandaHoldingHeader.tsx
import React from 'react';
import Image from 'next/image';

export default function AboutUsLandaHoldingHeader({ text, title, image }: { text: string, title: string, image: string }) {
    return (
...
>>>>>>> origin/develop:components/AboutUs/AboutUsLandaHoldingHeader.tsx
