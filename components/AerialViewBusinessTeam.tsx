...
export default function AerialViewBusinessTeam() {
  return (
    <div className="w-[1440px] h-[598px] bg-black bg-opacity-40 backdrop-blur-[10px]">
      ...
      <div className="w-[1006px] h-[380px] relative bg-neutral-500 bg-opacity-60">
        ...
        <div className="left-[66px] top-[23px] absolute justify-start items-center gap-[13px] inline-flex">
          ...
          <div className="h-[42px] flex-col justify-center items-start gap-[3px] inline-flex">
            <div className="w-[135px] h-[21px] text-white text-xl font-medium">
              Morteza Jafari
            </div>
            <div className="w-[179px] h-[18px] text-white text-base font-normal">
              Founder of IRimmigration
            </div>
            <div className="w-[162px] h-[18px] text-white text-[15px] font-normal">
              Investor
            </div>
          </div>
        </div>
