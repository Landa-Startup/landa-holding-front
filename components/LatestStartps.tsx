    ...
    <div>
      <div className="w-[1440px] h-[643px] relative bg-stone-100">
        <div className="w-[595px] h-[78px] flex-col justify-start items-start inline-flex">
          <div className="text-neutral-800 text-base font-normal tracking-[5.60px]">
            LANDA HOLDING
          </div>
          <div className="w-[595px] h-[59px] text-stone-500 text-[64px] font-normal">
            LASTEST STARTUPS
          </div>
        </div>
        <div className='flex flex-row'>
        <LatestStartupsCard
          image="https://via.placeholder.com/249x216"
          title="LANDA TRIP"
