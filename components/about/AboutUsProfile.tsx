  ...
  return (
    <div className="mb-10 flex w-full flex-col justify-center bg-[#FAFAFA]">
      <div className="m-auto flex w-5/6 flex-col justify-center px-4 py-10">
        <div
          className='flex flex-col justify-items-center py-5 text-black rtl:mr-10 '
        >
        ...
        <div className="mb-8 flex flex-col justify-between gap-24 md:flex-row md:gap-10">
          ...
          {t('boardMemebers', { returnObjects: true }).map(({ name, image, links, position }: { name: string; image: string; links: {
            linkedin: string,
            email: string,
            website: string,
            instagram: string
