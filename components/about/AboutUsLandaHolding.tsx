  ...
  return (
    <div className="flex flex-col lg:flex-col xl:flex-row items-center justify-evenly pt-5 md:py-32 bg-[#FAFAFA]">
      <div className="text-black p-3 space-y-3">
        <p className="text-4xl text-center font-gilda">About Landa Holding</p>
        <p className="lg:w-[450px] text-justify text-xl mt-4 md:mt-8 ml-0 md:mx-10 font-normal tracking-wide font-barlow mb-20">
