...
export default function AboutUsLandaHolding() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-between md:px-28 md:py-10 md:flex-row md:gap-8">
      <div className="md:pt-8 text-black md:px-0 md:w-[48%]">
        <p className="font-gilda text-2xl md:text-4xl font-bold text-black ">
          {t('aboutLandaHolding', { returnObjects: true })[0].title}
        </p>
        <p className="mb-20 mt-4 text-justify font-barlow text-medium font-normal md:pt-20 ">
          {t('aboutLandaHolding', { returnObjects: true })[0].text}
        </p>
      </div>
      <div className='relative object-contain mx-auto h-48 w-96 md:w-[48%] md:h-[340px]'>
        <Image
    ...
    <div className='flex flex-row items-start md:pl-24 md:rtl:pr-24 pb-24 md:mt-16'>
      <div className="relative h-[310px] hidden md:block w-screen md:h-[419px] md:w-[48%]"> 
        <Image
      ...
      <div className="mt-10 order-first px-10 md:px-0 md:ltr:pl-12 md:rtl:pr-12 md:order-last md:w-[45%] md:pt-0">
