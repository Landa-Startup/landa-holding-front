...
export default function StoryOfLanda() {
  return (
    <div className="flex flex-col gap-12">
      <div className="md:px-32 py-10 md:py-14 bg-[#FAFAFA]">
        <div className="flex flex-col lg:flex-row gap-12 text-[#000]">
          <div className="flex flex-col md:w-full lg:w-1/2 xl:w-1/2 text-justify px-10">
            ...
            <div className="flex flex-col text-[#000] font-barlow space-y-4">
              <p>
                Landa International Holding started its activity in 2017 in
                Canada as a certified and verified company in the field of
                investment, resource collection, business development, and
                startup planning. In 2021, after years of glorious and
                successful performance, Landa Holding became a federal company
                known in Canada and Iran.
              </p>
          ...
          <div className="flex flex-col md:w-full lg:w-1/2 xl:w-1/2 md:text-justify px-10">
            ...
            <ul className="flex flex-col space-y-3 mt-5">
              <li className="list-disc marker:text-primary">
                <span className="text-primary font-bold">Startup Academy</span>,
                a startup with the aim of fostering and accelerating the growth
                of teenagers, has been operating since 2017 under the
                supervision of the FarshTech company.
              </li>
              <li className="list-disc marker:text-primary">
      ...
      <div className="flex flex-col px-10 md:px-32 py-10 md:py-14 bg-white">
        ...
        <div className="flex flex-col space-y-4 mt-5">
          ...
          <p>
            ...
            membership, high-quality transaction flow, and extensive charitable
            activities. Landa benefits from collaboration and close
            ...
            capital, talent, technology, and resources necessary to establish a
